  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "not-prose farcaster-embed-container", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "farcaster-embed-stats", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("ul", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("a", { className: "farcaster-embed-stats-link", href: farcasterUrl, target: "_blank", onClick: handleSdkLinkClick, children: [
...
function FarcasterEmbed({
  ...
  const [castJson, setCastJson] = import_react3.default.useState(null);
  if (url) {
  ...
  if (!castJson)
    return null;
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(CastEmbed, { cast: castJson, client: true, options: { ...defaultOptions, ...options } });
}
